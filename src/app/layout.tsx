...
const url = "fortunicacasino-online.com";
const ogTitle = "Fortunica Casino Australia – Bonuses, Games, Payments & Support Guide";
const ogSiteName = "Fortunica Casino";
const metaDescription = "Fortunica Casino Australia offers top-tier games, generous bonuses, and secure payment methods for all players. Explore the full gaming experience today and claim your rewards.";
