...
const url = "playfrank-casino.com";
const ogTitle = "PlayFrank Casino UK 2025: Games, Bonuses & Real Player Experience";
const ogSiteName = "Playfrank Casino";
const metaDescription = "Discover what makes PlayFrank Casino stand out for UK players in 2025\\. Explore its Malta-licensed platform, welcome bonuses, and everyday rewards in this honest review.";
