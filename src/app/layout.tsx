...
const url = "uptown-pokies-fun.com";
const ogTitle = "Uptown Pokies Fun – Play Top Online Slots with Big Bonuses";
const ogSiteName = "Uptown Pokies Fun Casino";
const metaDescription = "Discover Uptown Pokies Fun, your destination for premium online slots and generous welcome bonuses. Safe, exciting, and mobile-friendly casino action awaits\\!";
