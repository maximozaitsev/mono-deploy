...
import {
  getContentData,
  parseAdvantageContent,
} from "../../utils/serverContent";
    ...
    <section className={`${styles.advantageSection} section`}>
      <div className="container">
        <h2 className="h2-heading white">
          {replaceCurrentYear(content.sectionTitle || "Advantages")}
        </h2>
        ...
        <div className={styles.columns}>
          <div className={styles.column}>
            {content.advantagesTitle && (
              <h4 className="h4-heading white">
                {replaceCurrentYear(content.advantagesTitle) ||
                  content.advantagesTitle}
              </h4>
            )}
          ...
          <div className={styles.column}>
            {content.disadvantagesTitle && (
              <h4 className="h4-heading white">
                {replaceCurrentYear(content.disadvantagesTitle) ||
                  content.disadvantagesTitle}
              </h4>
            )}
            <ul className="paragraph-text">
